...
description: "ROA measures the profit a company squeezes out of everything it owns. How it differs from ROE and ROCE, and why asset-light businesses score so differently."
image: /assets/og/roa.png
...
It's the broadest of the three, because total assets are the whole asset
base — funded not only by equity and borrowings (ROCE's capital) but also by
short-term liabilities like money owed to suppliers (payables).
