...
The [last post]({% post_url 2026-09-26-point-to-point-returns %}) showed the same index
...
The [last post]({% post_url 2026-09-26-point-to-point-returns %}) gave the fund's
