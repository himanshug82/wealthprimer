...
[WACC post]({% post_url 2026-09-28-wacc-cost-of-capital %}) used. Because the
...
[point-to-point post]({% post_url 2026-09-26-point-to-point-returns %}) showed this window
...
[drawdown post]({% post_url 2026-09-29-drawdown %}) was a many-standard-deviation event
