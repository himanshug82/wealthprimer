...
The [last post]({% post_url 2026-09-30-terminal-value-and-the-full-dcf %}) ended with a
...
[margin path]({% post_url 2026-09-29-forecasting-free-cash-flow %}) someone assumed, a beta borrowed
