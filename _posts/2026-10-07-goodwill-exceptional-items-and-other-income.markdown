...
A {{ a.year1_roic_pct }}% return on money that the [WACC post]({% post_url 2026-09-28-wacc-cost-of-capital %})
...
[forensic post]({% post_url 2026-10-04-desi-bites-cooks-the-books %}) had one of those.
