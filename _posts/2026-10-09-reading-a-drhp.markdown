...
the kind of thing the [capital allocation post]({% post_url 2026-10-08-capital-allocation %})
...
[contingent liabilities post]({% post_url 2026-10-06-contingent-liabilities-pledges-and-promoter-holding %}),
and promoter-group dealings in the [forensic post]({% post_url 2026-10-04-desi-bites-cooks-the-books %}). The
...
cheap. The [comparables post]({% post_url 2026-09-26-relative-valuation-comparables %})
is about choosing that table yourself.

One thing the section will *not* say is whether ₹{{ l.ipo_price }} is a good price.
Nor will this blog. The [terminal value post]({% post_url 2026-09-30-terminal-value-and-the-full-dcf %})
