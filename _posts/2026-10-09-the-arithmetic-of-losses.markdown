...
The [last post]({% post_url 2026-10-08-what-the-fo-numbers-actually-say %}) was about a base
...
σ (sigma) is the
[standard deviation]({% post_url 2026-09-30-volatility-and-sharpe %}) — a
...
This is why the [drawdown post]({% post_url 2026-09-29-drawdown %}) made such a
...
[point-to-point returns post]({% post_url 2026-09-26-point-to-point-returns %}) defined —
...
[Sharpe ratio]({% post_url 2026-09-30-volatility-and-sharpe %}) — volatility
