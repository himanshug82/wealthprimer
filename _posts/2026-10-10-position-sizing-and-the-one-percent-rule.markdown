...
[RSI post]({% post_url 2026-10-08-rsi %}) documented — the stock was moving
...
[recovery table]({% post_url 2026-10-09-the-arithmetic-of-losses %}): a 20%
