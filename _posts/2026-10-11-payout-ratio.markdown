...
the growth assumptions behind a [DCF]({% post_url 2026-09-29-forecasting-free-cash-flow %}).
...
useful sanity check on the [DCF]({% post_url 2026-09-30-terminal-value-and-the-full-dcf %}),
...
[capital allocation question]({% post_url 2026-10-08-capital-allocation %}) of what to do with
...
[operating leverage post]({% post_url 2026-10-09-operating-leverage %}), not the payout.
