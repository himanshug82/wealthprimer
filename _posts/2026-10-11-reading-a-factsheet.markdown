...
| Benchmark | Is it a **TRI** (total return index)? [The last post]({% post_url 2026-10-02-benchmarks-and-comparing-like-with-like %}) explains why this matters more than it looks |
...
Two numbers, direct and regular. From [the expense post]({% post_url 2026-09-28-expense-ratios-direct-vs-regular %}):
...
benchmark. As [the point-to-point returns post]({% post_url 2026-09-26-point-to-point-returns %}) showed, these all
...
Python in [the rolling returns post]({% post_url 2026-09-27-rolling-returns %}) is for.
...
[the volatility and Sharpe post]({% post_url 2026-09-30-volatility-and-sharpe %}): always check the period and the
...
[almost six years]({% post_url 2026-09-29-drawdown %}) to recover. That's the number that
...
do]({% post_url 2026-10-11-what-technical-analysis-cannot-do %}).
