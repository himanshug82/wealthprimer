...
[fundamental toolkit]({% post_url 2026-10-02-capstone-britannia-end-to-end %}) exists precisely because those questions
...
The RSI table from [that post]({% post_url 2026-10-08-rsi %}) is worth repeating, because
...
The [chart patterns post]({% post_url 2026-10-10-chart-patterns %}) demonstrated this
...
post]({% post_url 2026-10-05-trend-lines %}) showed how much can ride on it: the January
...
The [first post]({% post_url 2026-10-02-what-technical-analysis-is %}) left
