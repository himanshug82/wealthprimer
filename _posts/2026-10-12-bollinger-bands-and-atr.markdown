...
Everything in the [first ten posts]({% post_url 2026-10-02-what-technical-analysis-is %})
...
{% assign ds_end_s = ta2.dataset.end | date: "%s" %}{% assign lag_days = page.date | date: "%s" | minus: ds_end_s | divided_by: 86400 %}{{ lag_days | divided_by: 30 }} months before this post — well past the
...
[standard deviations]({% post_url 2026-09-30-volatility-and-sharpe %}) above it and
two below:
...
[moving average]({% post_url 2026-10-06-moving-averages %})**.
...
[RSI post]({% post_url 2026-10-08-rsi %}) documented. That's
...
[a whole post]({% post_url 2026-10-10-position-sizing-and-the-one-percent-rule %})
