...
cash flows are, which the [modified duration post]({% post_url 2026-10-06-modified-duration %})
...
YTM is the [yield to maturity]({% post_url 2026-10-05-yield-to-maturity %}) —
...
[Sharpe ratio post]({% post_url 2026-09-30-volatility-and-sharpe %}) taught you to
...
The categories post later in this series explains how SEBI's category labels
...
- **Forgetting tax.** Gains on debt-fund units bought on or after 1 April
  ...
  tax series post on debt funds<!-- RELINK 2026-10-30-debt-funds-gold-and-the-rest -->.
