...
[point-to-point CAGR]({% post_url 2026-09-26-point-to-point-returns %})
(compound annual growth rate),
[rolling returns]({% post_url 2026-09-27-rolling-returns %}), volatility, the
[Sharpe ratio]({% post_url 2026-09-30-volatility-and-sharpe %}) — are computed
...
is the volatility.
([XIRR]({% post_url 2026-10-01-sips-xirr-and-timing-myths %}), the extended
...
[SIP post's]({% post_url 2026-10-01-sips-xirr-and-timing-myths %}) Jan 2007 investor
...
[arithmetic of losses post]({% post_url 2026-10-09-the-arithmetic-of-losses %})
...
[SIP post's]({% post_url 2026-10-01-sips-xirr-and-timing-myths %})
...
This is why the [drawdown post's]({% post_url 2026-09-29-drawdown %}) recovery
