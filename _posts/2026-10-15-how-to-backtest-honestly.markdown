...
| Rule | In | Out |
|---|---|---|
| **SMA 50/200** — the [golden cross]({% post_url 2026-10-06-moving-averages %}) | 50-day average above 200-day | 50-day below 200-day |
| **SMA 20/50** — the same idea, faster | 20-day above 50-day | 20-day below 50-day |
| **RSI 30/70** — the textbook [oscillator]({% post_url 2026-10-08-rsi %}) rule | RSI falls below 30 | RSI rises above 70 |
...
[MACD post]({% post_url 2026-10-09-macd %}) was so uneasy about a signal
...
| | Final value | [Return a year]({% post_url 2026-09-26-point-to-point-returns %}) | [Worst drawdown]({% post_url 2026-09-29-drawdown %}) | Trades | Time invested |
|---|---:|---:|---:|---:|---:|
...
[limitations post]({% post_url 2026-10-11-what-technical-analysis-cannot-do %})
