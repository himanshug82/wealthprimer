...
could be forecast, a [DCF]({% post_url 2026-09-30-terminal-value-and-the-full-dcf %}).
...
[provisions post]({% post_url 2026-10-13-gnpa-nnpa-and-provisions %}) showed
...
[terminal value post]({% post_url 2026-09-30-terminal-value-and-the-full-dcf %}),
...
post doesn't try. (The [margin of safety post]({% post_url 2026-10-01-margin-of-safety-and-sensitivity %})
made the same point about DCF inputs; banks just make it faster.)

## ROA × leverage: where the ROE comes from

The [DuPont]({% post_url 2026-09-25-dupont-roe-decomposition %}) post split
...
{% include inr.html n=d.avg_leverage %} times. The [capital adequacy post]({% post_url 2026-10-14-capital-adequacy %})
is what caps the second number; the [NIM]({% post_url 2026-10-11-nim-and-the-spread %}),
[CASA]({% post_url 2026-10-12-casa-and-the-deposit-franchise %}) and
[provisions]({% post_url 2026-10-13-gnpa-nnpa-and-provisions %}) posts are what
drive the first.
