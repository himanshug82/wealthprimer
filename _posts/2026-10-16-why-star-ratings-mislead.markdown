...
[category definition]({% post_url 2026-10-14-sebi-fund-categories-decoded %}) decides who
...
the [expense ratio post]({% post_url 2026-09-28-expense-ratios-direct-vs-regular %})
...
- **A prompt to read the factsheet**, not a substitute for it. The
  [factsheet post]({% post_url 2026-10-11-reading-a-factsheet %}) covers what
  to look at instead: mandate, cost, portfolio, and
  [rolling returns]({% post_url 2026-09-27-rolling-returns %}) across many
