...
[drawdown post]({% post_url 2026-10-22-drawdown %}) showed that "financially
...
[last post but one]({% post_url 2026-11-09-diversification-is-a-correlation-problem %})
...
[SIP post]({% post_url 2026-10-24-sips-xirr-and-timing-myths %}) found that a
