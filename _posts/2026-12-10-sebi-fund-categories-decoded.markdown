...
[debt funds post]({% post_url 2026-12-08-debt-funds-explained %}) explained why both
...
[modified duration]({% post_url 2026-11-30-modified-duration %}) used to
...
Every performance comparison — returns, [rolling returns]({% post_url 2026-10-20-rolling-returns %}),
[drawdowns]({% post_url 2026-10-22-drawdown %}), [Sharpe ratios]({% post_url 2026-10-23-volatility-and-sharpe %}),
...
- **Assuming "large cap" means 100% large cap.** It means 80%. Check the
  ...
  [factsheet post]({% post_url 2026-10-26-reading-a-factsheet %}) shows where.
